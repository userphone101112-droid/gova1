...
import type { UiIdentifier } from '@/platform/ui/registry/registry';
 ...
 * UI format: page.section.component.element OR page.section.element (categories)
 */
 ...
 * 4-part: page.section.component.element → page.section.camelCaseElement
 * 3-part: page.section.element → page.section.camelCaseElement
 */
...
/**
 * Category/shared UI paths do not require bound translations.
 */
...
/**
 * Validate UI identifier format (3 or 4 segments)
 */
