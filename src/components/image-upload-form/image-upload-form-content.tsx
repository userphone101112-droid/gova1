    ...
    >
      <label
        data-ui-uuid={IMAGE_UPLOAD_FORM.FORM.FIELD1_LABEL.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.FORM.FIELD1_LABEL.uuid}`}
        htmlFor="image-upload-field1"
        className="block text-sm font-medium text-on-surface"
      >
        {t('image-upload-form.form.field1Label')}
      </label>
      <input
        id="image-upload-field1"
        data-ui-uuid={IMAGE_UPLOAD_FORM.FORM.FIELD1_INPUT.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.FORM.FIELD1_INPUT.uuid}`}
        type="text"
        value={field1}
        onChange={(event) => setField1(event.target.value)}
        placeholder={t('image-upload-form.form.field1')}
      ...
      <label
        data-ui-uuid={IMAGE_UPLOAD_FORM.FORM.FIELD2_LABEL.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.FORM.FIELD2_LABEL.uuid}`}
        htmlFor="image-upload-field2"
        className="block text-sm font-medium text-on-surface"
      >
        {t('image-upload-form.form.field2Label')}
      </label>
      <input
        id="image-upload-field2"
        data-ui-uuid={IMAGE_UPLOAD_FORM.FORM.FIELD2_INPUT.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.FORM.FIELD2_INPUT.uuid}`}
        type="text"
        value={field2}
        onChange={(event) => setField2(event.target.value)}
        placeholder={t('image-upload-form.form.field2')}
        className="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-on-surface placeholder:text-on-surface-variant"
      />

      <label
        data-ui-uuid={IMAGE_UPLOAD_FORM.FORM.FIELD3_LABEL.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.FORM.FIELD3_LABEL.uuid}`}
        htmlFor="image-upload-field3"
        className="block text-sm font-medium text-on-surface"
      >
        {t('image-upload-form.form.field3Label')}
      </label>
      <input
        id="image-upload-field3"
        data-ui-uuid={IMAGE_UPLOAD_FORM.FORM.FIELD3_INPUT.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.FORM.FIELD3_INPUT.uuid}`}
        type="text"
        value={field3}
        onChange={(event) => setField3(event.target.value)}
        placeholder={t('image-upload-form.form.field3')}
        className="w-full rounded-lg border border-outline-variant bg-surface px-3 py-2 text-on-surface placeholder:text-on-surface-variant"
      />
      ...
      >
        ...
        <input
          ...
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.GALLERY.FILE_INPUT.uuid}`}
          onChange={handleFileChange}
          className="hidden"
          aria-label={t('image-upload-form.gallery.fileInput')}
        />
        {previewImages.map((image) => (
          <img
            key={image.id}
            data-ui-uuid={IMAGE_UPLOAD_FORM.GALLERY.PREVIEW_IMAGE.uuid}
          data-ui-lang-uuid={`lang-${IMAGE_UPLOAD_FORM.GALLERY.PREVIEW_IMAGE.uuid}`}
            data-ui-instance-id={image.id}
            src={image.url}
            alt={t('image-upload-form.gallery.previewImage')}
